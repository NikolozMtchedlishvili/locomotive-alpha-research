...
By building this model, my educational macro-focused investment portfolio in 2025 generated **55.33% Time-Weighted Return (TWR)**, compared to the S&P 500 (VOO)'s TWR of **17.82%**.

---

## Fund Overview

The strategy focuses on identifying asymmetric macro and geopolitical opportunities across:

- Equity index ETFs  
- Volatility instruments  
- Commodities  
- Thematic sector exposures  
...
- Sentiment and volatility monitoring  
- Tactical ETF positioning  
...
## Examples of the Interactive Chart

1.
![New Plot](screenshots/newplot.png)

2. Zoomed to Jan 2025 to Feb 2026 period. Hovered over Aug 1, 2025 showing one of the headlines from AP News.
...
- Categorize news and assign different colors to markers for better visual analysis (geopolitics, monetary policy, government data, corporate earnings, etc).
